...
public class FindMax {
    ...
    public static void main(String[] args) {
        ...
        // Calling methods
       int findMaxFor = findMaxFor(myNumbers);
       int findMaxWhile = findMaxWhile(myNumbers);
    ...
    public static int findMaxFor(int myNumbers[]) {
    ...
    public static int findMaxWhile(int myNumbers[]) {
        int findMax = myNumbers[0];
        // I am stating at 1 because findMax is already set to the first element
        int counter = 1;
